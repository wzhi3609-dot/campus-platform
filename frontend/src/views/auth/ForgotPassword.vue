...
<template>
  <div style="max-width: 440px; margin: 0 auto; padding-top: 24px;">
    <h2 style="margin: 0 0 4px; font-size: 22px; text-align: center;">找回密码</h2>
    <p style="margin: 0 0 24px; color: #909399; font-size: 13px; text-align: center;">输入注册手机号和学号/工号，获取新密码</p>
    <div style="background: #fff; border-radius: 12px; border: 1px solid #f0f0f0; padding: 28px;">
      ...
      <div v-else style="text-align: center;">
        ...
        <p style="font-size: 14px; color: #909399;">你的新密码为：</p>
        <div style="background: #f5f7fa; border-radius: 8px; padding: 16px; margin: 16px 0; font-size: 20px; font-weight: 700; letter-spacing: 2px; color: #1a73e8;">{{ result }}</div>
